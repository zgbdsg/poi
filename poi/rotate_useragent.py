...
class RotateUserAgentMiddleware(UserAgentMiddleware):
    ...
    def process_request(self, request, spider):
        ...
        #request.headers.setdefault('Accept-Language', 'zh-CN,zh;q=0.8,en;q=0.6,zh-TW;q=0.4')
        #request.headers.setdefault('Referer', 'http://www.kuaidaili.com/free/inha/')
        #request.headers.setdefault('Connection', 'keep-alive')
        #request.headers.setdefault('Upgrade-Insecure-Requests', 1)
        #request.headers.setdefault('Pragma', 'no-cache')
        #request.headers.setdefault('Cache-Control', 'no-cache')
        #request.headers.setdefault('Host', 'www.kuaidaili.com')
        #request.headers.setdefault('Cookie', '_ydclearance=38047570b247444d6593c65c-b4d5-4a9a-b1a3-028f78949ac9-1490864143; channelid=0; sid=1490856321837286; _ga=GA1.2.539737738.1490834959; Hm_lvt_7ed65b1cc4b810e9fd37959c9bb51b31=1490834952; Hm_lpvt_7ed65b1cc4b810e9fd37959c9bb51b31=1490857432')
        
        ua = random.choice(self.user_agent)
        #ip,port = random.choice(self.proxys)
        #request.meta['proxy'] = "http://%s:%s"%(ip,port)

        if ua:
            request.headers.setdefault('User-Agent', ua)
            #request.headers.setdefault('User-Agent', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36')
